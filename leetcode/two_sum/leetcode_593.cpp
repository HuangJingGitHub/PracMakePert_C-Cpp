...
public:
    bool validSquare(vector<int>& p1, vector<int>& p2, vector<int>& p3, vector<int>& p4) {
        int sqrt_dis_1_2 = computeSqrtDistance(p1, p2),
            sqrt_dis_1_3 = computeSqrtDistance(p1, p3);
        ...
        int len_1_2 = computeSqrtDistance(p1, p2),
            len_1_3 = computeSqrtDistance(p1, p3),
            len_2_4 = computeSqrtDistance(p2, p4),
            len_3_4 = computeSqrtDistance(p3, p4),
    ...
    int computeSqrtDistance(vector<int>& p1, vector<int>& p2) {
