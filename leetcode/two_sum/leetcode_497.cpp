...
public:
    ...
    Solution(vector<vector<int>>& rects) {
        ...
        for (int i = 1; i < rect_num_; i++)
            ...
            // Note that side lengths need to be added by 1 since we are samping interger points covered by the rectangle uniformly, not 
            // all points covered by the redctangle.
