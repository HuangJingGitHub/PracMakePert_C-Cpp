...
int main(int argc, char** argv) {
    ...
    vector<Point2f> vertices1{Point2f(200, 0), Point2f(240, 0), Point2f(240, 100), Point2f(200, 100)},    
                    ...
                    vertices5{Point2f(400, 150), Point2f(440, 150), Point2f(440, 200), Point2f(400, 200)},
...
/*     DrawPath(backImg, smooth_path, Scalar(0, 255, 0));
    DrawPath(backImg, smooth_path, Scalar(255, 0, 0), 2, initial_feedback_pts[1] - initial_feedback_pts[0]); */
