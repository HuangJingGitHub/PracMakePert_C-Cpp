...
public:
   ...
   // Find countors of red shape
    ...
    cv::Scalar redLow(0, 173, 152), redHigh(10, 255, 255), 
                blackLow(0, 0, 0), blackHigh(149, 218, 71),
                DOLow(0, 130, 162), DOHigh(29, 255, 255);
    std::vector< std::vector<cv::Point>> contours;
    cv::Mat trackedImage, dst;
    ...
    cv::cvtColor(cv_ptr->image, trackedImage, COLOR_BGR2HSV);
